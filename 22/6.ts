...
export const easy: Challenge = (input) => input.split('').findIndex((_,i,t) => [...new Set(t.slice(i,i+4))].length == 4)+4

const hardSolutions = [19,23,23,29,26]

export const hard: Challenge = (input) => input.split('').findIndex((_,i,t) => [...new Set(t.slice(i,i+14))].length == 14)+14
...
// I'm trialing easy/hard terminology, not sure how I feel about it.
